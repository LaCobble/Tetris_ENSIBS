...
public class Main extends Application{
    ...
    // Speed of game, can change with the dfficulty
    ...
    private Parent createContent() {
        ...
        ImageView img = new ImageView(new Image("tetris.jpg"));
            ...
            setOnMouseClicked(event -> {
                switch (name) {
                    case "Start" -> {
                        ...
                        tetrisApplication.start(new Stage());
                        // close the menu
                    ...
                    case "Options" -> {
                        ...
                        speed = optionsPage.getSpeedOnOptionPage();
                        // close the menu
